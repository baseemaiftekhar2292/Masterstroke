...
import { 
  Sparkles, Mic, Volume2, Send, Cpu, Zap, Globe, RefreshCw, Radio, Tag, UserCheck
} from 'lucide-react';
...
const MENTORS = [
  {
    ...
    welcomeText: "Namaste! Main Ananya Ma'am. NCERT ke organic reactions aur concepts ko instant decode karenge."
  },
  {
    id: 'kabir',
    name: "Kabir Sir",
    ...
    welcomeText: "Hey Toppers! Kabir Sir here. Physics numericals se darna nahi hai, shortcuts apply karo!"
  }
];
    ...
    <div className="min-h-screen bg-[#04060B] text-slate-100 font-sans relative overflow-hidden selection:bg-cyan-500 selection:text-black">
      ...
      <header className="sticky top-0 z-50 backdrop-blur-2xl bg-[#04060B]/80 border-b border-cyan-500/20 px-6 py-4 flex flex-wrap justify-between items-center gap-4 shadow-[0_4px_30px_rgba(0,0,0,0.9)]">
        <div className="flex items-center gap-3">
          ...
          <div>
            {/* Clean Logo without 2050 AI Tag */}
            ...
            <p className="text-[10px] text-cyan-400/70 tracking-widest uppercase">JEE & NEET AI Doubt Engine</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3 flex-wrap">
          ...
          {/* Pricing Button with Discount Code NEWTOMASTER */}
      ...
      <main className="max-w-7xl mx-auto px-4 py-8 grid grid-cols-1 lg:grid-cols-12 gap-8 relative z-10">
        ...
        {/* LEFT PANEL: Mentor Selector with Visual Placeholder Icons */}
          ...
          <div className="bg-slate-900/60 border border-cyan-500/30 rounded-3xl p-5 backdrop-blur-xl shadow-[0_0_40px_rgba(0,0,0,0.8)]">
            ...
            <div className="space-y-4">
              {MENTORS.map((m) => (
                ...
                >
                  {/* Stylish Avatar Placeholder Badge before image upload */}
                  <div className="relative">
                    <div className={`w-16 h-16 rounded-xl border flex items-center justify-center font-bold text-xl shadow-inner ${
                      m.gender === 'female' 
                        ? 'bg-gradient-to-tr from-pink-500/20 to-purple-500/30 border-pink-400/50 text-pink-300' 
                        : 'bg-gradient-to-tr from-cyan-500/20 to-blue-500/30 border-cyan-400/50 text-cyan-300'
                    }`}>
        ...
        {/* RIGHT PANEL: Glowing Cyber Chat Workspace */}
